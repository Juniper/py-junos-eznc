...
facts = {'domain': None, 'hostname': 'firefly', 'ifd_style': 'CLASSIC', \
         'version_info': 'junos.version_info(major=(12, 1), type=X, minor=(46, \'D\', 10), build=2)', \
         '2RE': False, 'serialnumber': '123456789102', 'fqdn': 'firefly', 'virtual': True, \
         'switch_style': 'NONE', 'version': '12.1X46-D10.2', 'HOME': '/cf/var/home/rick', \
         'srx_cluster': False, 'model': 'FIREFLY-PERIMETER', \
         'RE0': {'status': 'Testing', 'last_reboot_reason': 'Router rebooted after a normal shutdown.', 'model': 'FIREFLY-PERIMETER RE', 'up_time': '1 minute, 10 seconds'}, \
...
class TestDevice(unittest.TestCase):    
    ...
    def test_device_open(self):        
        ...
        self.dev.open()
        assert self.dev.connected == True
    ...
    def test_device_execute(self):
        ...
        assert self.dev.execute.call_args[0][0] == '<get-software-information/>'              
                                                              
    def test_device_rpcmeta(self):
        assert self.dev.rpc.get_software_information.func_doc == 'get-software-information'
    ...
    def test_device_close(self):
        ...
        self.dev.close()
        assert self.dev.connected == False
