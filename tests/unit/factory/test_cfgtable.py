...
class TestFactoryCfgTable(unittest.TestCase):
    ...
    def test_cfgtable_get_options(self, mock_execute):
        ...
        self.assertEqual(self.zit._get_opt,
                         {'inherit': 'defaults', 'groups': 'groups'})
    ...
    def test_cfgtable_str_key_field(self, mock_execute):
        ...
        self.assertEqual(
            xml.xpath(
                'routing-options/autonomous-system/as-number')[0].text, '100'
        )
    ...
    def test_cfgtable_field_value_xpath(self, mock_execute):
        ...
        self.assertEqual(
            xml.xpath(
                'routing-options/autonomous-system/as-number')[0].text, '150'
        )
